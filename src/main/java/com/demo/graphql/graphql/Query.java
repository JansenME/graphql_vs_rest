...
public class Query implements GraphQLQueryResolver {
    ...
    public User getUser(final String numberOfAccounts, final DataFetchingEnvironment environment) {
        ...
        return userService.getUserForGraphQL(
                Integer.valueOf(numberOfAccounts),
                requestedFields.contains(GraphQLFieldName.ACCOUNTID),
                requestedFields.contains(GraphQLFieldName.BALANCE));
    }
}
